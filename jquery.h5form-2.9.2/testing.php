...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="css/jquery.h5form-2.9.2.css" />
	...
	<script type="text/javascript" src="en/jquery.h5form-2.9.2.js"></script>
...
&lt;input <strong>name="test-15b"</strong> type="button" value="checkValidity"&gt;
	  ...
	  <p>
		NOTE: A stored message cannot be cleared by other means with modern browsers, but may be cleared by change events with IE.
	  </p>
