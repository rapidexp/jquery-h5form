...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="css/jquery.h5form-2.4.css" />
	...
	<script type="text/javascript" src="en/jquery.h5form-2.4.js"></script>
...
&lt;/form&gt;
	  ...
	  <p>It send the context of clicked button rather than the value in IE 7 or earlier.
...
&lt;/form&gt;
	  ...
	  <p>The default type of a button element is "button" rather than "submit" in IE 7 or earlier.<br>
...
&lt;/form&gt;
	...
	<section>
	  ...
	  <h3>Test-4. <a id="test-4">The required attributes and etc.</a> <sup>[IE 9-]</sup></h3>

	  <p>The following input elements have new attributes of HTML5 as the placeholder, the pattern and the required.<br>
		You will not be entered in the text box that an incorrect value.</p>
...
<pre class="source" style="display:none">
&lt;form action="#test-4" method="post"&gt;
  &lt;input type="text" name="input-4" <strong>placeholder="xxxx-xxx"</strong>
...
&lt;/form&gt;
	  ...
	  <h3>Test-5. <a id="test-5">The email and url state</a> <sup>[IE 9-]</sup></h3>
		...
		<tr>
		  <td>
			<form action="#test-5" method="post" class="h5form">
			  <input type="email" name="input-5">
			  <input type="submit" name="test-5" value="submit">
			</form>
<pre class="source" style="display:none">
&lt;form action="#test-5" method="post" class="h5form"&gt;
  &lt;input <strong>type="email"</strong> name="input-5"&gt;
  &lt;input type="submit" name="test-5" value="submit"&gt;
&lt;/form&gt;
</pre>
		  </td>
		  <td>
			<form action="#test-5" method="post" class="h5form">
			  <input type="url" name="input-5" placeholder="http://">
			  <input type="submit" name="test-5" value="submit">
			</form>
<pre class="source" style="display:none">
&lt;form action="#test-5" method="post" class="h5form"&gt;
  &lt;input <strong>type="url"</strong> name="input-5" placeholder="http://"&gt;
  &lt;input type="submit" name="test-5" value="submit"&gt;
&lt;/form&gt;
</pre>
		  </td>
	  ...
	  <h3>Test-6. <a id="test-6">The number and range state</a> <sup>[IE 9-] [Firefox]</sup></h3>
		...
		<tr>
		  <td>
			<form action="#test-6" method="post" class="h5form">
			  <input type="Number" name="input-6" min="12" max="30" step="0.5" title="From 12 to 30 step 0.5">
			  <input type="submit" name="test-6" value="submit">
			</form>
<pre class="source" style="display:none">
&lt;form action="#test-6" method="post" class="h5form"&gt;
  &lt;input <strong>type="Number"</strong> name="input-6"
...
&lt;/form&gt;
		  ...
		  <td>
			<form action="#test-6" method="post" class="h5form">
			  <input type="Range" name="input-6" step="10">
			  <input type="submit" name="test-6" value="submit">
			</form>
<pre class="source" style="display:none">
&lt;form action="#test-6" method="post" class="h5form"&gt;
  &lt;input <strong>type="range"</strong> name="input-6" <strong>step="10"</strong>&gt;
  &lt;input type="submit" name="test-6" value="submit"&gt;
&lt;/form&gt;
&lt;</pre>
		  </td>
	  ...
	  <h3>Test-7. <a id="test-7">The date state and the time state</a> <sup>[IE 9-] [Firefox] [Chrome] [Safari]</sup></h3>
		...
		<tr>
		  <td>
			<form action="#test-7" method="post" class="h5form">
			  <input type="date" name="input-7" min="<?php echo date('Y-m-d');?>" max="<?php echo date('Y-m-d', strtotime('+1 week'));?>" title="One week from today">
			  <input type="submit" name="test-7" value="submit">
			</form>
<pre class="source" style="display:none">
&lt;form action="#test-7" method="post" class="h5form"&gt;
  &lt;input <strong>type="date"</strong> name="input-7" <strong>min="<?php echo date('Y-m-d');?>"</strong>
...
&lt;/form&gt;
		  ...
		  <td>
			<form action="#test-7" method="post" class="h5form">
			  <input type="time" name="input-7" min="7:00" max="18:00" step="600" title="From 7:00 to 18:00 step 10 minutes">
			  <input type="submit" name="test-7" value="submit">
			</form>
<pre class="source" style="display:none">
&lt;form action="#test-7" method="post" class="h5form"&gt;
  &lt;input <strong>type="time"</strong> name="input-7" <strong>min="7:00" max="18:00"</strong>
...
&lt;/form&gt;
	  ...
	  <h3>Test-8. <a id="test-8">The date and time state</a> <sup>[IE 9-] [Firefox] [Chrome] [Safari]</sup></h3>
		...
		<tr>
		  <td>
			<form action="#test-8" method="post" class="h5form">
			  <input type="datetime" name="input-8" min="<?php echo gmdate('Y-m-d\TH:i:s', ceil(time()/1800)*1800).'Z';?>" step="1800" title="Every 30 minutes from now.">
			  <input type="submit" name="test-8" value="submit">
			</form>
<pre class="source" style="display:none">
&lt;form action="#test-8" method="post" class="h5form"&gt;
  &lt;input <strong>type="datetime"</strong> name="input-8"
...
&lt;/form&gt;
		  ...
		  <td>
			<form action="#test-8" method="post" class="h5form">
			  <input type="datetime-local" name="input-8" min="<?php echo date('Y-m-d\TH:i:s', ceil(time()/1800)*1800); ?>" step="1800" title="Every 30 minutes from now.">
			  <input type="submit" name="test-8" value="submit">
			</form>
<pre class="source" style="display:none">
&lt;form action="#test-8" method="post" class="h5form"&gt;
  &lt;input <strong>type="datetime-local"</strong> name="input-8"
...
&lt;/form&gt;
	...
	<section>
	  ...
	  <h3>Test-9. <a id="test-9">The form attribute</a> <sup>[IE 9-]</sup></h3>
	  ...
	  <table class="sample">
		...
		<tr>
		  <td>
			<form id="form-a" action="#test-9" method="post" class="h5form">
			  <input type="text" name="input-9" value="This is Form A">
			  <input type="submit" name="test-9" value="input" form="form-b">
			</form>
<pre class="source" style="display:none">
&lt;form <strong>id="form-a"</strong> action="#test-9" method="post" class="h5form"&gt;
  &lt;input type="text" name="input-9" value="This is From A"&gt;
  &lt;input type="submit" name="test-9" value="input"
   <strong>form="form-b"</strong>&gt;
&lt;/form&gt;
</pre>
		  </td>
		  <td>
			<form id="form-b" action="#test-9" method="post" class="h5form">
			  <input type="test" name="input-9" value="This is Form B">
			  <button type="submit" name="test-9" value="This is Button B" form="form-a">button</button>
			</form>
<pre class="source" style="display:none">
&lt;form <strong>id="form-b"</strong> action="#test-9" method="post" class="h5form"&gt;
  &lt;input type="test" name="input-9" value="This is Form B"&gt;
  &lt;button type="submit" name="test-9" value="This is Button B"
...
&lt;/form&gt;
	  ...
	  <h3>Test-10. <a id="test-10">The formaction attribute and etc.</a> <sup>[IE 9-]</sup></h3>
...
&lt;/form&gt;
		  ...
		  <td>
			<form action="#test-10" method="post" class="h5form">
			  ...
			  <button type="submit" name="test-10" value="validate">button</button>
			  <button type="submit" name="test-10" value="novalidate" formnovalidate="novalidate">button</button>
			</form>
<pre class="source" style="display:none">
&lt;form action="#test-10" method="post" class="h5form"&gt;
  &lt;input type="text" name="input" <strong>required pattern="\d{4}-\d{3}"</strong>&gt;&lt;br&gt;
  &lt;button type="submit" name="test-10" value="validate"&gt;button&lt;/button&gt;
  &lt;button type="submit" name="test-10" value="novalidate"
